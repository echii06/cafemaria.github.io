	      	...
	      	<div class="div-result">
				  ...
				  <div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane" id="productInfo">
				    	...
				    	<div class="form-group">
			        	<label for="editProductdate" class="col-sm-3 control-label">Product Date: </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="date" class="form-control" id="editProductdate" placeholder="Product Date" name="editProductdate" autocomplete="off">
						    </div>
			        </div> <!-- /form-group-->	  
